...
window.getChartThemeColors = () => {
  ...
  return {
    ...
    incomeColor: isDark ? '#34d399' : '#10b981',
    spendingColor: isDark ? '#818cf8' : '#4f46e5',
    secondaryColor: isDark ? '#fb7185' : '#f43f5e',
    cardColor: isDark ? '#0b0f19' : '#ffffff',
    tooltipBg: isDark ? '#111827' : '#ffffff',
    tooltipText: isDark ? '#f9fafb' : '#0f172a',
    palette: isDark
      ? ['#a5b4fc', '#fb7185', '#2dd4bf', '#fde047', '#fdba74', '#5eead4', '#f59e0b']
      : ['#4f46e5', '#f43f5e', '#0f766e', '#fbbf24', '#fb923c', '#2dd4bf', '#d97706']
  };
};
